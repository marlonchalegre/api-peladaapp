...
(s/defn create-request->model :- models.organization/Organization
  ...
  (-> request
      (select-keys [:name :waha_api_url :waha_instance :waha_group_id :waha_enabled :waha_start_msg_enabled :waha_end_msg_enabled :waha_attendance_reminder_enabled :waha_vote_reminder_enabled :waha_vote_ended_msg_enabled :waha_use_all_mention_fallback])
...
(s/defn model->response :- responses.organization/OrganizationResponse
  ...
  (-> model
      (select-keys [:id :name :owner-id :waha-api-url :waha-instance :waha-group-id :waha-enabled :waha-start-msg-enabled :waha-end-msg-enabled :waha-attendance-reminder-enabled :waha-vote-reminder-enabled :waha-vote-ended-msg-enabled :waha-use-all-mention-fallback])
      (update-keys (comp keyword #(str/replace % "-" "_") name))))
...
(s/defn db->model :- models.organization/Organization
  ...
  (some-> o
          misc/unamespace
          (select-keys [:id :name :owner_id :waha_api_url :waha_instance :waha_group_id :waha_enabled :waha_start_msg_enabled :waha_end_msg_enabled :waha_attendance_reminder_enabled :waha_vote_reminder_enabled :waha_vote_ended_msg_enabled :waha_use_all_mention_fallback])
          (update-keys (comp keyword #(str/replace % "_" "-") name))
          ...
          (update :waha-use-all-mention-fallback #(if (nil? %) true (= 1 %)))))
