(ns api-100folego.routes
  (:require
   [api-100folego.handlers.auth :as auth]
   [api-100folego.handlers.match :as handler.match]
   [api-100folego.handlers.organization :as handler.organization]
   [api-100folego.handlers.pelada :as handler.pelada]
   [api-100folego.handlers.player :as handler.player]
   [api-100folego.handlers.team :as handler.team]
   [api-100folego.handlers.substitution :as handler.substitution]
   [api-100folego.handlers.vote :as handler.vote]
   [api-100folego.handlers.user :as handler.user]
